      ...
      <div className="max-w-7xl mx-auto px-6 h-16 sm:h-[68px] flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-3">
          <div className="flex items-center gap-1 border-r border-theme-border/60 pr-3">
            {socialLinks.map((social) => (
              <a
                ...
                className="p-1.5 rounded-none sm:rounded-[4px] text-theme-muted hover:text-theme-primary hover:bg-theme-primary/10 transition group"
              >
          ...
          <a
            ...
            className="p-2 rounded-none sm:rounded-[4px] bg-[#25D366]/15 text-[#25D366] border border-[#25D366]/40 hover:bg-[#25D366] hover:text-white transition-all duration-300 flex items-center justify-center group shadow-sm"
          >
          ...
          <a
            ...
            className="text-xs font-mono font-semibold text-theme-muted hover:text-theme-primary transition flex items-center gap-1.5 px-2.5 py-1.5 rounded-none sm:rounded-[4px] hover:bg-theme-border/20"
          >
